---
name: code-reviewer
description: Reviews code for adherence to project guidelines, bugs, and quality issues. Use proactively after writing or modifying code, before committing, or before opening a PR. By default reviews the unstaged git diff; the caller may specify different files or scope.
