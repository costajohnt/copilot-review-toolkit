...
description: Reviews a change for test coverage quality and completeness - behavioral coverage, critical gaps, and test quality - without being pedantic about 100% coverage. Use after a PR is created/updated or as a pre-merge check. Advisory only.
